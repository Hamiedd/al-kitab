                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post"
                                            action="{{ route('admin.languages.update', $lang) }}">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <select name="dir" id="dir" class="form-control @error('dir') is-invalid @enderror">
                                                            <option value="rtl" @if(old('dir',$config['dir']) === 'rtl') selected @endif> {{__('labels.fields.rtl')}}</option>
                                                            <option value="ltr" @if(old('dir',$config['dir']) === 'ltr') selected @endif> {{__('labels.fields.ltr')}}</option>
                                                        </select>
                                                        @error('dir')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
