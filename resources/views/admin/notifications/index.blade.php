                                            ...
                                            <form class="form form-horizontal" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <div class="col-12 mb-2">
                                                            <label for="receivers">
                                                                {{ __('labels.fields.receivers') }}
                                                                <span class="text-danger">*</span>
                                                            </label>
                                                            <select name="receivers" id="receivers"
                                                                class="form-control @error('receivers') is-invalid @enderror">
                                                                <option value="1"
                                                                    {{ old('receivers') == 1 ? 'selected' : '' }}>
                                                                    {{ trans_choice('labels.models.user', 2) }}</option>
                                                            </select>
                                                            @error('receivers')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                    ...
                                    <table class="table" id="table">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th>{{ __('labels.fields.receivers') }}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @switch($notification->receivers)
                                                            @case(1)
                                                                <span
                                                                    class="badge badge-success">{{ trans_choice('labels.models.user', 2) }}</span>
                                                            @break

                                                            @case(2)
                                                                <span
                                                                    class="badge badge-info">{{ trans_choice('labels.models.driver', 2) }}</span>
                                                            @break

                                                            @case(3)
                                                                <span
                                                                    class="badge badge-primary">{{ trans_choice('labels.models.store', 2) }}</span>
                                                            @break

                                                            @case(4)
                                                                <span
                                                                    class="badge badge-secondary">{{ __('labels.fields.all') }}</span>
                                                            @break
