                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description[{{$lang}}]" id="description_{{$lang}}"
                                                                      ...
                                                                      dir="{{$config['dir']}}"
                                                                      rows="3">{{old("description.$lang",$section->translate('description',$lang,false))}}</textarea>
...
{{--                                                <div class="col-12 mb-2" >--}}
{{--                                                    <div class="form-group" >--}}
{{--                                                        <label  for="color">{{ __('labels.fields.color') }}--}}
{{--                                                        </label>--}}
{{--                                                        <input type="color"--}}
{{--                                                               class="form-control @error('color') is-invalid @enderror"--}}
{{--                                                               id="color" name="color"--}}
{{--                                                               placeholder="{{ __('labels.fields.color') }}"--}}
{{--                                                               value="{{ old("color",$section->color) }}" />--}}
{{--                                                        @error("color")--}}
{{--                                                        <div class="invalid-feedback">{{ $message }}</div>--}}
{{--                                                        @enderror--}}
{{--                                                    </div>--}}
