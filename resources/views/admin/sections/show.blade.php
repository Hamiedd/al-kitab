                                        ...
                                        <div class="collapse-default">
                                            @foreach(getLangs() as $lang => $config)
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="collapse-name-{{$lang}}" role="tabpanel" aria-labelledby="headingCollapse-name-{{$lang}}" class="collapse">
                                                        <div class="card-body">
                                        ...
                                        <div class="collapse-default">
                                            @foreach(getLangs() as $lang => $config)
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="collapse-description-{{$lang}}" role="tabpanel" aria-labelledby="headingCollapse-description-{{$lang}}" class="collapse">
                                                        <div class="card-body">
